...
BEGIN
	...
	INSERT INTO HOADON (NgayDatSan,MaKH, MaSan, TongPhut, DonGia, TongTien)
	VALUES (@THOIGIANBD,@MaKH,@MaSan, @TongPhut, @GiaThue, @ThanhTien)
...
BEGIN
	...
	UPDATE HOADON
	SET TONGTIEN = @ThanhTien + (TongTien - d.ThanhTien), NgayDatSan = @ThoiGianBD, MaKH = @MaKH, TongPhut = @TongPhut, DonGia = @GiaThue, MaSan = @MaSan
	FROM deleted d
...
-- Đạt
INSERT INTO LICHDATSAN (THOIGIANBD, THOIGIANKT, MAKH, MASAN, DonGia)
VALUES ('11-20-2023 16:00', '11-20-2023 18:00', 1, 1, 100000)

INSERT INTO LICHDATSAN (THOIGIANBD, THOIGIANKT, MAKH, MASAN, DonGia)
VALUES('11-20-2023 15:30', '11-20-2023 18:00', 2, 4, 300000)

INSERT INTO LICHDATSAN (THOIGIANBD, THOIGIANKT, MAKH, MASAN, DonGia)
VALUES('11-20-2023 15:00', '11-20-2023 17:00', 3, 8, 500000)

INSERT INTO LICHDATSAN (THOIGIANBD, THOIGIANKT, MAKH, MASAN, DonGia)
VALUES('11-18-2023 14:00', '11-18-2023 17:00', 4, 1, 100000)

INSERT INTO LICHDATSAN (THOIGIANBD, THOIGIANKT, MAKH, MASAN, DonGia)
VALUES('11-17-2023 13:00', '11-17-2023 18:00', 5, 2, 100000)

INSERT INTO LICHDATSAN (THOIGIANBD, THOIGIANKT, MAKH, MASAN, DonGia)
VALUES('11-20-2023 15:00', '11-20-2023 17:00', 6, 11, 1000000)
...
as 
begin
	SELECT MAHD, NgayDatSan, NgayTao, MAKH, HOADON.MASAN, TongPhut, DonGia, TONGTIEN, TrangThai
	FROM HOADON, SANBONG
